      ...
      <div>
        <Menu.Button
          className="inline-flex justify-center rounded-md
                 border border-zinc-400 dark:border-zinc-700 px-2 py-2 text-sm 
                 font-medium shadow-sm hover:bg-orange-200 dark:hover:bg-zinc-800 
      ...
      >
        <Menu.Items className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md border border-zinc-400 dark:border-zinc-700 bg-orange-50 dark:bg-zinc-800 shadow-xl ring-1 ring-black ring-opacity-5 focus:outline-none divide-zinc-400 dark:divide-zinc-700">
          <div className="py-1">
            ...
            <DropdownMenuItem href="/categorias/computing">
              Programación
            </DropdownMenuItem>
            <DropdownMenuItem href="/categorias/reading">
              Lecturas
            </DropdownMenuItem>
            <DropdownMenuItem href="/categorias/travel">
              Viajes
            </DropdownMenuItem>
          </div>
        </Menu.Items>
